...
<div class="form-wrap">
	...
	<form name="tch_form" method="post" action="#" onsubmit="return tch_submit()"  >
      <h3><?php _e('Update Details', 'tiny-carousel-horizontal-slider'); ?></h3>
		...
		<input name="tch_width" type="text" id="tch_width" value="<?php echo esc_attr($form['tch_width']); ?>" maxlength="4" />
		...
		<input name="tch_height" type="text" id="tch_height" value="<?php echo esc_attr($form['tch_height']); ?>" maxlength="4" />
		...
		<input name="tch_intervaltime" type="text" id="tch_intervaltime" value="<?php echo esc_attr($form['tch_intervaltime']); ?>" maxlength="4" />
		...
		<input name="tch_duration" type="text" id="tch_duration" value="<?php echo esc_attr($form['tch_duration']); ?>" maxlength="4" />
		...
		<input name="tch_folder" type="text" id="tch_folder" value="<?php echo esc_attr($form['tch_folder']); ?>" size="100" maxlength="1024" />
